...
- Preconfigured **compliance reports** (Inventory, Network Access, Policy Audit) that are installed with {{prodname}}
...
![compliance-reporting](/img/calico-enterprise/master/compliance-reporting.png)
