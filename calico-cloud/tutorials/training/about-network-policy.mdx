...
To learn more about {{prodname}} network policies, read the [Get started with {{prodname}} network
policy](../../network-policy/beginners/calico-network-policy.mdx) guide.
...
![Example mix of network policy types](/img/calico-cloud/master/example-k8s-calico-policy-mix.svg)
...
deny](../../network-policy/beginners/kubernetes-default-deny.mdx) network policies. These ensure that if no other policy is
...
![Example tiers](/img/calico-cloud/master/example-tiers.svg)
