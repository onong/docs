...
![dashboards](/img/calico-cloud/master/dashboards.png)
...
![service-graph](/img/calico-cloud/master/service-graph.png)
...
![service-graph-namespace](/img/calico-cloud/master/service-graph-namespace.png)
...
![edges](/img/calico-cloud/master/edges.png)
...
![service-graph-layers](/img/calico-cloud/master/service-graph-layers.png)
...
![service-graph-flows](/img/calico-cloud/master/service-graph-flows.png)
...
![packet-capture-service](/img/calico-cloud/master/packet-capture-service.png)
...
![flow-viz](/img/calico-cloud/master/flow-viz.png)
...
![policy-board](/img/calico-cloud/master/policy-board.png)
...
![policy-filters](/img/calico-cloud/master/policy-filters.png)
...
![recommend-policy](/img/calico-cloud/master/recommend-policy.png)
...
![stage-policyl](/img/calico-cloud/master/stage-policy.png)

**Preview**

When you edit a policy, you can select **Preview** to see how changes may affect existing traffic.

![policy-preview](/img/calico-cloud/master/policy-preview.png)
...
![endpoints](/img/calico-cloud/master/endpoints.png)

**Node List**

This page lists all nodes associated with your cluster.

![node-list](/img/calico-cloud/master/node-list.png)
...
![networksets](/img/calico-cloud/master/networksets.png)
...
![managed-clusters](/img/calico-cloud/master/managed-clusters.png)
...
![cis-benchmark](/img/calico-cloud/master/cis-benchmark.png)

Using the filter, you can select report types.

![compliance-filter](/img/calico-cloud/master/compliance-filter.png)
...
![timeline](/img/calico-cloud/master/timeline.png)
...
![alerts](/img/calico-cloud/master/alerts.png)

As shown, there are many types of alerts you can enable. None are enabled by default.  
**Anomaly Detection**

This page lets you enable/disable anomaly detectors that are preconfigured by {{prodname}}. Anomaly detection uses {{prodname}} Elasticsearch logs (flow logs, L7 logs, and DNS logs) to learn the behavior of cluster nodes, pods, services, and other entities that send log records (applications, load balancers, databases, etc.).
...
![kibana-dashboards](/img/calico-cloud/master/kibana-dashboards.png)
...
![kibana](/img/calico-cloud/master/kibana.png)
