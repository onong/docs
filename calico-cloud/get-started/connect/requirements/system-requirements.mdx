...
| **Kubernetes version**      | - Minimum: v1.21<br/>- Maximum: v1.23<br /><br />If you have a later version than the maximum, contact [Support](https://support.tigera.io/).                                                                     |
| **CNIs**                    | - Calico CNI v3.15 to v3.23<br/>- Amazon VPC CNI<br/>- Azure CNI<br/>- GKE CNI                                                                                                                                    |
