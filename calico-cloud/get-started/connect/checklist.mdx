...
To upload diagnostics to {{prodname}} support automatically, run the following command:
...
If you have verified all of the above steps and still have issues, you can move on to the [Tigera Operator checklist](operator-checklist.mdx).
