...
1.  Install AWS per-account resources.
    ...
    --template-body {{filesUrl_CE}}/manifests/aws/security-group-integration/account-cf.yaml
...
1.  Install AWS per-VPC resources.
    ...
    --template-body {{filesUrl_CE}}/manifests/aws/security-group-integration/vpc-cf.yaml
...
1.  Install AWS per-cluster resources.
    ...
    --template-body {{filesUrl_CE}}/manifests/aws/security-group-integration/cluster-cf.yaml
