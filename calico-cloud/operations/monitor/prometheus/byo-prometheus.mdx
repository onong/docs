...
```batch
kubectl apply -f /manifests/prometheus/elasticsearch-metrics-service-monitor.yaml -n $NAMESPACE
```
...
```batch
kubectl apply -f  /manifests/prometheus/fluentd-metrics-service-monitor.yaml -n $NAMESPACE
```
...
```batch
kubectl apply -f  /manifests/prometheus/calico-node-monitor-service-monitor.yaml -n $NAMESPACE
```
...
```batch
kubectl apply -f  /manifests/prometheus/kube-controller-metrics-service-monitor.yaml-n $NAMESPACE
```
...
```batch
kubectl apply -f  /manifests/prometheus/felix-metrics-service-monitor.yaml -n $NAMESPACE
```
...
```batch
kubectl apply -f  /manifests/prometheus/typha-metrics-service-monitor.yaml -n $NAMESPACE
```
