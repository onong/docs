...
1. From the Available Fields section in the side panel, select the `_index` field.
   ...
   ![Kibana Cluster Indexes](/img/calico-enterprise/master/mcm/mcm-kibana.png)
