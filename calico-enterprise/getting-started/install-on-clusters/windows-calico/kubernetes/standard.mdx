...
Install {{prodnameWindows}} on Kubernetes clusters. This {{prodnameWindows}} standard installation requires time and expertise for configuration. To get started quickly, we recommend the [Quickstart](../quickstart.mdx).
