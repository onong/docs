...
![policy-types](/img/calico-enterprise/master/policy-types.png)
...
![policy-tiers](/img/calico-enterprise/master/policy-tiers.png)
...
![default-tier](/img/calico-enterprise/master/default-tier.png)
...
The Tigera Operator manages this tier and reverts any user edits to policy or moving of this tier. This ensures that you do not inadvertently impact the operation of {{prodname}}. However, you can still change how traffic is enforced using policies in adjacent tiers. For details, see [Change allow-tigera tier behavior](allow-tigera.mdx).
...
![hidden-tiers](/img/calico-enterprise/master/hidden-tiers.png)
...
![tier-order](/img/calico-enterprise/master/tier-order.png)
...
![policy-processing](/img/calico-enterprise/master/policy-processing.png)
...
![tier-funnel](/img/calico-enterprise/master/tier-funnel.png)
...
![implicit-deny](/img/calico-enterprise/master/implicit-deny.svg)
...
![endpoint-match](/img/calico-enterprise/master/endpoint-match.svg)
