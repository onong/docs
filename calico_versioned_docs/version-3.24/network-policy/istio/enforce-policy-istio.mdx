...
4. [Enable application layer policy](app-layer-policyindex.mdx).
...
You can also
[view the manifest in your browser](/network-policy/tutorials/app-layer-policy/manifests/10-yaobank.yaml/).
...
For example, the [Heartbleed](http://heartbleed.com) vulnerability in OpenSSL allowed attackers to
...
You can also
[view the manifest in your browser](/network-policy/tutorials/app-layer-policy/manifests/30-policy.yaml/).
