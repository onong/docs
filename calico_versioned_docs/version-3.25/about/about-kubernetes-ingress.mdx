...
![In-cluster ingress](/img/calico/3.25/ingress-in-cluster.svg)
...
![External ingress](/img/calico/3.25/ingres-external.svg)
...
![In-cluster ingress with NLB local](/img/calico/3.25/ingress-in-cluster-nlb-local.svg)

**External ingress solution via node ports**

![External ingress via node port](/img/calico/3.25/ingress-external-node-ports.svg)

**External ingress solution direct to pods**

![External ingress direct to pods](/img/calico/3.25/ingress-external-direct-to-pods.svg)
