...
You can get up and running with Calico by following any of the {{prodname}} [install
guides](../getting-started/index.mdx) without needing to be a networking expert. Calico hides the complexities for
...
![OSI network layers diagram](/img/calico/3.25/osi-network-layers.svg)
...
![Anatomy of a network packet](/img/calico/3.25/anatomy-of-a-packet.svg)
...
![Anatomy of an overlay network packet](/img/calico/3.25/anatomy-of-an-overlay-packet.svg)
