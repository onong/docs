...
![Kubernetes Service conceptual diagram](/img/calico/3.25/k8s-service-concept.svg)
...
![kube-proxy cluster IP](/img/calico/3.25/kube-proxy-cluster-ip.svg)
...
![kube-proxy node port](/img/calico/3.25/kube-proxy-node-port.svg)
...
![kube-proxy load balancer](/img/calico/3.25/kube-proxy-load-balancer.svg)
...
![kube-proxy service advertisement](/img/calico/3.25/kube-proxy-service-advertisement.svg)
...
![kube-proxy service advertisement](/img/calico/3.25/kube-proxy-service-local.svg)
...
dataplane](../operations/ebpf/enabling-ebpf.mdx) supports native service handling. This preserves source IP to
...
![kube-proxy service advertisement](/img/calico/3.25/calico-native-service-handling.svg)
