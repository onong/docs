...
>
  <div className='col-md-6'>
    <img
      ...
      src='/img/calico/3.25/felix_icon.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
<div style={{ textAlign: 'center' }}>
  <h2 id='why-use'>Why use {{ prodname }}?</h2>
</div>
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/multiple-dataplanes.png'
    />
  </div>
</div>
...
<div id="why-use-calico-2" className='row'>
  <div className='col-md-6'>
    <img className='img-responsive center-block' src="/img/calico/3.25/intro/best-practices.png"/>
  </div>
  <div className='col-md-6'>
    <h3 id="best-practices" style={{ marginTop: '5px' }}>Best practices for network security</h3>
    <p>{{prodname}}’s rich network policy model makes it easy to lock down communication so the only traffic that flows is the traffic you want to flow. Plus with built in support for Wireguard encryption, securing your pod-to-pod traffic across the network has never been easier.</p>

    <p>{{prodname}}’s policy engine can enforce the same policy model at the host networking layer and (if using Istio & Envoy) at the service mesh layer, protecting your infrastructure from compromised workloads and protecting your workloads from compromised infrastructure.</p>
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/performance.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/scale.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/interoperability.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/deployed.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
      id='real-world-production'
      style={{ marginTop: '5px' }}
    >
...
>
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/policy.png'
    />
  </div>
</div>
...
>
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/intro/community.png'
    />
  </div>
  <div className='col-md-6'>
    <h3
      id='contributor-community'
      style={{ marginTop: '5px' }}
    >
...
<div
  id='why-use-calico-10'
  className='row'
>
  <div className='col-md-6'>
    <h3
      id='enterprise-compatible'
      style={{ marginTop: '5px' }}
    >
  ...
  <div className='col-md-6'>
    <img
      className='img-responsive center-block'
      src='/img/calico/3.25/calico-cloud-small.png'
    />
    <div
    ...
    >
      <a
        href='https://www.tigera.io/tigera-products/calico-cloud/'
