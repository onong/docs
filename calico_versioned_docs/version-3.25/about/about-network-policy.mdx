...
policy](../network-policy/get-started/kubernetes-policy/kubernetes-network-policy.mdx) guide.
...
policy](../network-policy/get-started/calico-policy/calico-network-policy.mdx) guide.
...
![Example mix of network policy types](/img/calico/3.25/example-k8s-calico-policy-mix.svg)
...
deny](../network-policy/get-started/kubernetes-default-deny.mdx) network policies. These ensure that if no other policy is
...
![Example tiers](/img/calico/3.25/example-tiers.svg)
