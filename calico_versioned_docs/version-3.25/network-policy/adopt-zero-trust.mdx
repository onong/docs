...
- {{prodname}} with application layer policy for Istio
...
Follow the instructions to [Enable application layer policy](istio/app-layer-policyindex.mdx).
...
![zero-trust-app](/img/calico/3.25/zero-trust-app.png)
...
![zero-trust-app](/img/calico/3.25/zero-trust-deploy.png)
