...
<Tabs>
<TabItem label="bash" value="bash-0">
...
The powershell and porter pod manifests below use images based on `mcr.microsoft.com/windows/servercore:1809`.
...
<TabItem label="PowerShell" value="PowerShell-1">
