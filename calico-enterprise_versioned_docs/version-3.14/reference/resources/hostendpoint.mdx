...
import Endpointport from '@site/calico-enterprise_versioned_docs/version-3.14/_includes/content/_endpointport.mdx';
...
> **Important**: When rendering security rules on other hosts, {{prodname}} uses the
