...
import DefaultInstall from '@site/calico-enterprise_versioned_docs/version-3.14/_includes/content/_default-install.mdx';
...
![customize install](/img/calico-enterprise/3.14/customize-install.png)
