...
1. [Install and configure calicoctl](../../../../operations/clis/calicoctl/install.mdx)
...
1. Finally, follow the {{prodnameWindows}} [quickstart guide for Kubernetes](../quickstart.mdx#install-calico-enterprise-for-windows-manually)
