...
![policy-types](/img/calico-enterprise/3.14/policy-types.png)
...
![policy-tiers](/img/calico-enterprise/3.14/policy-tiers.png)
...
![default-tier](/img/calico-enterprise/3.14/default-tier.png)
...
![hidden-tiers](/img/calico-enterprise/3.14/hidden-tiers.png)
...
![tier-order](/img/calico-enterprise/3.14/tier-order.png)
...
![policy-processing](/img/calico-enterprise/3.14/policy-processing.png)
...
![tier-funnel](/img/calico-enterprise/3.14/tier-funnel.png)
...
![implicit-deny](/img/calico-enterprise/3.14/implicit-deny.svg)
...
![endpoint-match](/img/calico-enterprise/3.14/endpoint-match.svg)
