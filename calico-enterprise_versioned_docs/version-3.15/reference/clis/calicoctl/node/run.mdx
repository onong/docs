...
Options:
  -h --help                Show this screen.
     ...
     --node-image=<DOCKER_IMAGE_NAME>
                           ...
                           [default: {{registry}}{{imageNames.node}}:latest]
     --backend=(bird|none)
...
Description:
  This command is used to start a {{nodecontainer}} container instance which provides
...
[Configuring `{{nodecontainer}}`](../../../component-resources/node/configuration.mdx).
