...
![policy-types](/img/calico-enterprise/3.15/policy-types.png)
...
![policy-tiers](/img/calico-enterprise/3.15/policy-tiers.png)
...
![default-tier](/img/calico-enterprise/3.15/default-tier.png)
...
![hidden-tiers](/img/calico-enterprise/3.15/hidden-tiers.png)
...
![tier-order](/img/calico-enterprise/3.15/tier-order.png)
...
![policy-processing](/img/calico-enterprise/3.15/policy-processing.png)
...
![tier-funnel](/img/calico-enterprise/3.15/tier-funnel.png)
...
![implicit-deny](/img/calico-enterprise/3.15/implicit-deny.svg)
...
![endpoint-match](/img/calico-enterprise/3.15/endpoint-match.svg)
