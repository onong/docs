...
![policy-tutorial-overview](/img/calico-enterprise/3.15/policy-tutorial-overview.png)
...
![policy-parts](/img/calico-enterprise/3.15/policy-parts.png)
...
- **Global**
  ...
  ![policy-tutorial-global-scope](/img/calico-enterprise/3.15/policy-tutorial-global-scope.png)
...
- **Namespace**
  ...
  ![policy-tutorial-namespace-scope](/img/calico-enterprise/3.15/policy-tutorial-namespace-scope.png)
...
![blue-namespace](/img/calico-enterprise/3.15/blue-namespace.png)

the resulting scope in our diagram would be only the pods labeled, `FE`:

![blue-namespace-pods](/img/calico-enterprise/3.15/blue-namespace-pods.png)
...
![policy-tutorial-endpoint-selector](/img/calico-enterprise/3.15/policy-tutorial-endpoint-selector.png)
...
![endpoint-selector-blue-green](/img/calico-enterprise/3.15/endpoint-selector-blue-green.png)
...
![namespace-selector](/img/calico-enterprise/3.15/namespace-selector.png)

### Network selector

Using the Nets selector, we can add CIDR addresses to be matched by the policy rule.

![network-selector](/img/calico-enterprise/3.15/network-selector.png)
...
![service-account-selector](/img/calico-enterprise/3.15/service-account-selector.png)
...
![match-all-namespace](/img/calico-enterprise/3.15/match-all-namespace.png)

To do this, we can use the policy rule endpoint selector, **Match All**.

![match-all-endpoints](/img/calico-enterprise/3.15/match-all-endpoints.png)

Not only is the pod labeled `BE` included, but also the {{prodname}} `networkset-1`.

![match-all-endpoints-example](/img/calico-enterprise/3.15/match-all-endpoints-example.png)
...
![namespace-match-all](/img/calico-enterprise/3.15/namespace-match-all.png)

**Global selector**

Let's see what happens when we select the **Global** selector.

![namespace-selector-global](/img/calico-enterprise/3.15/namespace-selector-global.png)
...
![heps-networksets](/img/calico-enterprise/3.15/heps-networksets.png)
...
![unspecified](/img/calico-enterprise/3.15/unspecified.png)
...
![policy-ordering](/img/calico-enterprise/3.15/policy-ordering.png)
...
![policy-tutorial-action](/img/calico-enterprise/3.15/policy-tutorial-action.png)
