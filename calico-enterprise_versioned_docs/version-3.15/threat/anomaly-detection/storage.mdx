...
import PersistentStorageTerms from '@site/calico-enterprise_versioned_docs/version-3.15/_includes/content/_persistent-storage-terms.mdx';
...
In the following example for an AWS cloud provider integration, the **StorageClass** tells {{prodname}} to use EBS disks for log storage.
