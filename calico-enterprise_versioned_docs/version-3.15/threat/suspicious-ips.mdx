...
3. In {{prodname}} Manager, go to the “Alerts” page to view events that are generated when an IP is displayed on the threat feed list.
...
Open {{prodname}} Manager, and navigate to the “Alerts” page. If any of your pods have been communicating with the IP addresses in the FEODO tracker feed, you will see the results listed on this page. It is normal to not see any events listed on this page.
